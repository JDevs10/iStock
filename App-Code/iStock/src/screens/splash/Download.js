...
import { StyleSheet, View, Text, ImageBackground, Image, StatusBar, AsyncStorage, Alert, BackHandler, Dimensions } from 'react-native';
...
class Download extends Component {
  ...
  async componentDidMount() {
    writeInitLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name);
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Check data :: if db tables are empty...");

    const checkData = new CheckData();
    console.log('#######################################################');
    console.log('########## CheckData');
    const data_check = await checkData.checkOrderData().then(async (val) => {
      return await val;
    });
    ...
    if(data_check){
      ...
      writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Data is good, skipe download to home screen...");
      this.props.navigation.navigate('dashboard');
      return;
    }

    writeLog(LOG_TYPE.WARNING, Download.name, this.componentDidMount.name, "Data is not good...");
    ...
    const settings = {
      ...
      limitUsersUpdate: DEFAULT_SETTINGS.SETTINGS.limitUsersUpdate,
      limitClientsUpdate: DEFAULT_SETTINGS.SETTINGS.limitClientsUpdate,
      limitProductsUpdate: DEFAULT_SETTINGS.SETTINGS.limitProductsUpdate,
      limitImagesUpdate: DEFAULT_SETTINGS.SETTINGS.limitImagesUpdate,
      limitWarehousesUpdate: DEFAULT_SETTINGS.SETTINGS.limitWarehousesUpdate,
      limitShipmentsUpdate: DEFAULT_SETTINGS.SETTINGS.limitShipmentsUpdate
    };
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Insert defaut settings, "+JSON.stringify(settings)+"...");
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Get token from db...");
    ...
    if(token == null){
      writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Unknown token...");
    ...
    if(!sync_info.status){
      changeKeepAwake(false);
      writeLog(LOG_TYPE.ERROR, Download.name, this.componentDidMount.name, "Pre Sync data faild...");
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Start downloads...");
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Download Orders..."+currentStep+"/"+allSteps);
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Download Clients..."+currentStep+"/"+allSteps);
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Download Products..."+currentStep+"/"+allSteps);
    ...
    if(settings.isUseImages){
      ...
      writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Download Product image..."+currentStep+"/"+allSteps);
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Download Warehouses..."+currentStep+"/"+allSteps);
    ...
    writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Download Expeditions..."+currentStep+"/"+allSteps);
   ...
   if(res_ == true){
      writeLog(LOG_TYPE.INFO, Download.name, this.componentDidMount.name, "Navigate to dashbord");
      ...
      writeLog(LOG_TYPE.ERROR, Download.name, this.componentDidMount.name, "BDC server is not reachable, so exist app...");
  ...
  async download_orders(token, ids_list) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders.name, "Download Orders...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
  ...
  async download_orders_contacts(token, ids_list) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders_contacts.name, "Download Orders Contacts...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders_contacts.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                console.log('Status != 200');
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders_contacts.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders_contacts.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
  ...
  async download_orders_clients(token, ids_list) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders_clients.name, "Download Orders Clients...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders_clients.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                console.log('Status != 200');
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders_clients.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders_clients.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
  ...
  async download_orders_users(token, ids_list) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders_users.name, "Download Orders Users...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders_users.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                console.log('Status != 200');
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders_users.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders_users.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
  ...
  async download_orders_products(token, ids_list) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders_products.name, "Download Orders Products...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders_products.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                console.log('Status != 200');
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders_products.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders_products.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
  ...
  async download_orders_warehouse(token, ids_list, isListFull = false) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders_warehouse.name, "Download Orders Warehouses...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders_warehouse.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                console.log('Status != 200');
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders_warehouse.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders_warehouse.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
  ...
  async download_orders_shipments(token, ids_list) {
    writeLog(LOG_TYPE.INFO, Download.name, this.download_orders_shipments.name, "Download Orders Shipments...");
    ...
    return await new Promise(async (resolve) => {
      ...
      if(ids_list != null && ids_list.length > 0){
        for(let x = 0; x < ids_list.length; x++){
          ...
          writeLog(LOG_TYPE.URL, Download.name, this.download_orders_shipments.name, "Url => "+url+"&DOLAPIKEY="+token.token);
          console.log(url);
          ...
          .then(async (response) => {
              if(response.status == 200){
                ...
                console.log('Status != 200');
                writeLog(LOG_TYPE.WARNING, Download.name, this.download_orders_shipments.name, "An error :=:> "+JSON.stringify(response.data));
                await resolve(false);
              }
              ...
              writeLog(LOG_TYPE.ERROR, Download.name, this.download_orders_shipments.name, "An error :=:> "+JSON.stringify(error));
              await resolve(false);
          });
        }
      }
